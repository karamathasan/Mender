...
# from elements._2D.node import Node
from elements._2D.nodegraph import NodeGraph, GraphEdge, Node
...
if __name__ == "__main__":
    ...
    #graphs
    node_arr = [Node(1,Transform2D(np.array([-3,0]))), Node(2, Transform2D(np.array([0,5]))), Node(3, Transform2D(np.array([3,0])))]
    # src_tg = np.array(
    #     [
    #         [0,0,1,1,2,2],
    #         [1,2,0,2,0,1]
